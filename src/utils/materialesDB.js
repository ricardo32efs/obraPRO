...
export const MATERIALES_DB = [
  ...
  { nombre: 'Tubo cuadrado 40x40x2mm', unidad: 'm lineal', categoria: 'Herrería y soldadura' },
  { nombre: 'Tubo cuadrado 50x50x2mm', unidad: 'm lineal', categoria: 'Herrería y soldadura' },
  { nombre: 'Tubo rectangular 40x20x2mm', unidad: 'm lineal', categoria: 'Herrería y soldadura' },
  { nombre: 'Tubo redondo 1" x 2mm', unidad: 'm lineal', categoria: 'Herrería y soldadura' },
  { nombre: 'Ángulo de hierro 30x30x3mm', unidad: 'm lineal', categoria: 'Herrería y soldadura' },
  { nombre: 'Ángulo de hierro 50x50x5mm', unidad: 'm lineal', categoria: 'Herrería y soldadura' },
  { nombre: 'Chapa lisa 1.5mm', unidad: 'm²', categoria: 'Herrería y soldadura' },
  { nombre: 'Chapa lisa 2mm', unidad: 'm²', categoria: 'Herrería y soldadura' },
  { nombre: 'Electrodo 3.25mm rutílico', unidad: 'kg', categoria: 'Herrería y soldadura' },
  { nombre: 'Disco de corte 230mm', unidad: 'unidad', categoria: 'Herrería y soldadura' },
  { nombre: 'Disco de desbaste 230mm', unidad: 'unidad', categoria: 'Herrería y soldadura' },
  { nombre: 'Pintura anticorrosiva', unidad: 'litro', categoria: 'Herrería y soldadura' },
  { nombre: 'Candado para portón', unidad: 'unidad', categoria: 'Herrería y soldadura' },
  { nombre: 'Bisagra de acero 3"', unidad: 'unidad', categoria: 'Herrería y soldadura' },
  { nombre: 'Cerradura para reja', unidad: 'unidad', categoria: 'Herrería y soldadura' },

  // Carpintería
  { nombre: 'Madera MDF 18mm', unidad: 'm²', categoria: 'Carpintería' },
  { nombre: 'Madera MDF 9mm', unidad: 'm²', categoria: 'Carpintería' },
  { nombre: 'Melamina blanca 18mm', unidad: 'm²', categoria: 'Carpintería' },
  { nombre: 'Madera terciada 18mm', unidad: 'm²', categoria: 'Carpintería' },
  { nombre: 'Madera terciada 9mm', unidad: 'm²', categoria: 'Carpintería' },
  { nombre: 'Bisagra para mueble', unidad: 'unidad', categoria: 'Carpintería' },
  { nombre: 'Corredera telescópica 45cm', unidad: 'unidad', categoria: 'Carpintería' },
  { nombre: 'Cerradura de embutir', unidad: 'unidad', categoria: 'Carpintería' },
  { nombre: 'Manija para puerta', unidad: 'unidad', categoria: 'Carpintería' },
  { nombre: 'Cola vinílica 1kg', unidad: 'unidad', categoria: 'Carpintería' },
  { nombre: 'Tornillos para MDF 3.5x35mm', unidad: 'caja', categoria: 'Carpintería' },
  { nombre: 'Tapacanto melamínico', unidad: 'm lineal', categoria: 'Carpintería' },
  { nombre: 'Barniz para madera', unidad: 'litro', categoria: 'Carpintería' },
  { nombre: 'Laca para madera', unidad: 'litro', categoria: 'Carpintería' },

  // Paisajismo y jardines
  { nombre: 'Tierra negra de jardín', unidad: 'm³', categoria: 'Paisajismo y jardines' },
  { nombre: 'Mantillo orgánico', unidad: 'm³', categoria: 'Paisajismo y jardines' },
  { nombre: 'Sustrato universal', unidad: 'bolsa 50L', categoria: 'Paisajismo y jardines' },
  { nombre: 'Fertilizante granulado', unidad: 'kg', categoria: 'Paisajismo y jardines' },
  { nombre: 'Semilla de césped', unidad: 'kg', categoria: 'Paisajismo y jardines' },
  { nombre: 'Tepes de césped', unidad: 'm²', categoria: 'Paisajismo y jardines' },
  { nombre: 'Bordura plástica para jardín', unidad: 'm lineal', categoria: 'Paisajismo y jardines' },
  { nombre: 'Adoquín de hormigón', unidad: 'm²', categoria: 'Paisajismo y jardines' },
  { nombre: 'Piedra blanca decorativa', unidad: 'bolsa', categoria: 'Paisajismo y jardines' },
  { nombre: 'Manguera de riego 1/2"', unidad: 'm lineal', categoria: 'Paisajismo y jardines' },
  { nombre: 'Aspersor de riego', unidad: 'unidad', categoria: 'Paisajismo y jardines' },
  { nombre: 'Cinta de goteo', unidad: 'm lineal', categoria: 'Paisajismo y jardines' },

  // Instalación de gas
  { nombre: 'Caño de cobre 3/8" (gas)', unidad: 'm lineal', categoria: 'Instalación de gas' },
  { nombre: 'Caño de cobre 1/2" (gas)', unidad: 'm lineal', categoria: 'Instalación de gas' },
  { nombre: 'Caño de acero 1/2" (gas)', unidad: 'm lineal', categoria: 'Instalación de gas' },
  { nombre: 'Caño de acero 3/4" (gas)', unidad: 'm lineal', categoria: 'Instalación de gas' },
  { nombre: 'Llave de paso de gas 1/2"', unidad: 'unidad', categoria: 'Instalación de gas' },
  { nombre: 'Regulador de gas domiciliario', unidad: 'unidad', categoria: 'Instalación de gas' },
  { nombre: 'Fitting para cobre soldable', unidad: 'unidad', categoria: 'Instalación de gas' },
  { nombre: 'Soldadura para cobre (estaño)', unidad: 'unidad', categoria: 'Instalación de gas' },
  { nombre: 'Termotanque eléctrico 60L', unidad: 'unidad', categoria: 'Instalación de gas' },
  { nombre: 'Termotanque a gas 60L', unidad: 'unidad', categoria: 'Instalación de gas' },
  { nombre: 'Calefón a gas', unidad: 'unidad', categoria: 'Instalación de gas' },
  { nombre: 'Cañería flexible de gas', unidad: 'm lineal', categoria: 'Instalación de gas' },

  // Aire acondicionado y ventilación
  { nombre: 'Equipo split frío/calor 3000 fg', unidad: 'unidad', categoria: 'Climatización' },
  { nombre: 'Equipo split frío/calor 5000 fg', unidad: 'unidad', categoria: 'Climatización' },
  { nombre: 'Caño de cobre 1/4" + 3/8" (AC)', unidad: 'm lineal', categoria: 'Climatización' },
  { nombre: 'Cañería aislada 1/4" + 1/2" (AC)', unidad: 'm lineal', categoria: 'Climatización' },
  { nombre: 'Soporte para compresor exterior', unidad: 'unidad', categoria: 'Climatización' },
  { nombre: 'Cañería de desagüe AC', unidad: 'm lineal', categoria: 'Climatización' },
  { nombre: 'Ventilador de techo', unidad: 'unidad', categoria: 'Climatización' },
  { nombre: 'Rejilla de ventilación', unidad: 'unidad', categoria: 'Climatización' },
]
